  ...
  const features = [
    {
      ...
      description: "Extract invoice data instantly using advanced AI vision technology"
    },
    {
      icon: <Database className="h-8 w-8" />,
      title: "IPFS Storage",
      description: "Secure, decentralized storage for your documents and extracted data"
    },
    {
      icon: <ShieldCheck className="h-8 w-8" />,
      title: "Blockchain Security",
      description: "Immutable records on Solana blockchain for ultimate data integrity"
    }
  ];
      ...
      <header className="relative z-50 px-6 py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#features" className="text-zinc-400 hover:text-[#e78a53] transition-colors">Features</a>
            <a href="#how-it-works" className="text-zinc-400 hover:text-[#e78a53] transition-colors">How it Works</a>
            <a href="#security" className="text-zinc-400 hover:text-[#e78a53] transition-colors">Security</a>
          </nav>
      ...
      <section className="relative z-10 px-6 pt-20 pb-32">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <Badge variant="secondary" className="inline-flex items-center gap-2 px-4 py-2 text-sm bg-zinc-800/50 text-zinc-300 border-zinc-700">
          ...
          >
            ...
            <p className="text-xl text-zinc-400 max-w-3xl mx-auto leading-relaxed">
              Upload your invoices, let AI extract the data, store it securely on IPFS, 
              and record immutable proof on the Solana blockchain. The future of document processing is here.
            </p>
          </motion.div>
                ...
                {features.map((feature, index) => (
                  ...
                  >
                    <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full mb-4 ${
                      currentFeature === index ? 'bg-[#e78a53]/20 text-[#e78a53]' : 'bg-zinc-700 text-zinc-400'
                    }`}>
                      {feature.icon}
                    </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
              Experience the complete invoice processing pipeline with cutting-edge technology
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Advanced computer vision extracts data from any invoice format with 99% accuracy"
              },
              {
                icon: <Database className="h-6 w-6" />,
                title: "IPFS Integration",
                description: "Decentralized storage ensures your documents are always accessible and tamper-proof"
              },
              {
                icon: <ShieldCheck className="h-6 w-6" />,
                title: "Blockchain Proof",
                description: "Solana blockchain creates immutable records of all processed documents"
              },
              {
                icon: <Zap className="h-6 w-6" />,
                title: "Lightning Fast",
                description: "Process invoices in seconds with our optimized AI and blockchain infrastructure"
              },
              {
                icon: <FileText className="h-6 w-6" />,
                title: "Multi-format Support",
                description: "Works with PDFs, images, and scanned documents in any language"
              },
              {
                icon: <DollarSign className="h-6 w-6" />,
                title: "Cost Effective",
                description: "Pay only for what you use with transparent, blockchain-based pricing"
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      <section id="how-it-works" className="relative z-10 px-6 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400 text-lg">Simple, secure, and lightning-fast processing</p>
          </div>

          <div className="grid md:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Upload", description: "Drop your invoice image or PDF", icon: <Upload className="h-8 w-8" /> },
              { step: "02", title: "AI Processing", description: "AI extracts all relevant data", icon: <Bot className="h-8 w-8" /> },
              { step: "03", title: "IPFS Storage", description: "Files stored on decentralized network", icon: <Database className="h-8 w-8" /> },
              { step: "04", title: "Blockchain Proof", description: "Immutable record on Solana", icon: <ShieldCheck className="h-8 w-8" /> }
            ].map((step, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <div className="text-2xl font-bold text-[#e78a53] mb-2">{step.step}</div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-zinc-400 text-lg mb-8">
              Join the future of document management with AI, IPFS, and blockchain technology
            </p>
            <Button
              onClick={onGetStarted}
              size="lg"
